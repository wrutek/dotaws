...
**Tests**: Automated tests are REQUIRED for every feature change. Include test tasks for each user story and changed behavior.
...
- [ ] T004 [P] Configure static type checking in CI (e.g., mypy)
...
- [ ] TXXX Run lint and type checks in CI configuration
